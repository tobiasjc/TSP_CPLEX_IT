...
public class GraphDraw extends JPanel {
	...
	GraphDraw(ArrayList<City> data, ArrayList<Edge> tour, double[][] distanceFromTo, int index) {
		this.data = data;
		this.tour = tour;
	...
	protected void paintComponent(Graphics g) {
		...
		double scaleX = super.getWidth() / 100.0;
		double scaleY = super.getHeight() / 100.0;
